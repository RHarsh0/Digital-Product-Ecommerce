...
.then(res=>res.json())
 ...
 show.innerHTML= getCard(data.id,data.name,data.category,data.image,data.price)});
});
...
.then((data)=>{
  console.log(data);
    ...
    updateItemImageInput.value = data.image;
    updateItemCategoryInput.value = data.category;
